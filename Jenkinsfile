pipeline {
	...
	environment {		
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/attiny1617-quadrature-decoding-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/attiny1617-quadrature-decoding-studio.git'
